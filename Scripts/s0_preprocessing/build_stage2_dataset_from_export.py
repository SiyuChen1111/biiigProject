...
- EEG source: `Data/InputData/raw/Kosciessa_et_al_2021/temp_data/resp_locked_erp.mat`.
- Behavior source: `Data/InputData/raw/Kosciessa_et_al_2021/temp_data/behavior_data_all.csv`.
...
def main() -> None:
    ...
    parser.add_argument(
        "--mat",
        type=Path,
        default=Path("Data/InputData/raw/Kosciessa_et_al_2021/temp_data/resp_locked_erp.mat"),
    )
    parser.add_argument(
        "--behavior",
        type=Path,
        default=Path("Data/InputData/raw/Kosciessa_et_al_2021/temp_data/behavior_data_all.csv"),
    )
    parser.add_argument("--output-dir", type=Path, default=Path("Data/ProcessedData"))
