...
CHECKPOINT_PATH = ROOT / "evidence" / "dataset_fixed_forward_gru_clean" / "stage2" / "best_model.pt"
LATENTS_PATH = DATASET_DIR / "latents_full" / "latents_full.npz"
LATENT_REPORT_PATH = DATASET_DIR / "latents_full" / "latent_extraction_report.json"
OUT_DIR = ROOT / "model_neural_training_validation_audit"
